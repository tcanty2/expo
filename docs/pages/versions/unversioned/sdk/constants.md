...
> ⚠️ **This property is deprecated and will be removed in the SDK 43. Please, implement it on your own using `expo-application`'s [`androidId`](../application/#applicationandroidid) on Android and a storage API such as [`expo-secure-store`](../securestore/) on iOS and `localStorage` on Web.**
