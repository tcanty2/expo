...
#import <ABI40_0_0EXNotifications/ABI40_0_0EXInstallationIdProvider.h>
...
@implementation ABI40_0_0EXInstallationIdProvider

ABI40_0_0UM_EXPORT_MODULE(NotificationsInstallationIdProvider)

ABI40_0_0UM_EXPORT_METHOD_AS(getInstallationIdAsync, getInstallationIdAsyncWithResolver:(ABI40_0_0UMPromiseResolveBlock)resolve rejecter:(ABI40_0_0UMPromiseRejectBlock)reject)
{
